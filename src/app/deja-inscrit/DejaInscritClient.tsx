...
export default function DejaInscritClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-6">
          <Link href="/inscription" className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-800 text-sm font-medium">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm text-center">
          ...
          <div className="flex flex-col gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center w-full text-white font-semibold py-3.5 rounded-xl transition-opacity hover:opacity-90"
